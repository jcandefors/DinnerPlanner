...
public class SummaryButtonListener implements OnClickListener{
	...
	public SummaryButtonListener(DinnerModel model, SummaryView mainView){
		this.model = model;
	...
	public void onClick(View v) {
		...
		case R.id.summary_text_title_id: mainView.tabTitle.setText(R.string.ingredients_text);			
