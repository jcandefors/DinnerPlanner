...
public class SummaryView {
	...
	public SummaryView(View view, DinnerModel model) {
		...
		if(starter != null){		
			instrbutton1.setImageDrawable(view.getResources().getDrawable(R.drawable.toast));
		...
		if(main != null){
			instrbutton2.setImageDrawable(view.getResources().getDrawable(R.drawable.meatballs));
		...
		if(desert != null){
			//ImageButton instrbutton3 = (ImageButton) view.findViewById(R.id.instrButton2);
